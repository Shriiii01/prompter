...
class DatabaseService:
    ...
    async def increment_user_prompts(self, email: str) -> int:
        """Increment user's prompt count and return new count - SIMPLE INCREMENT ONLY."""
        ...
        try:
            # Use direct fallback method ONLY to avoid double counting
            # The record_enhancement_atomic RPC also increments, causing double counts
            logger.info(f" DATABASE: Using direct increment (not RPC to avoid double count)")
